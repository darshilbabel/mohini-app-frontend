...
import PTMVoiceBasedChat from "./pages/ShikshalokamMegaPTM/PTMVoiceBasedChat";
...
const unprotected_old_routes = [
  ...
  { path: ROUTES.SHIKSHALOKAM_PTM_CHAT_PAGE, element: <PTMVoiceBasedChat type={sessionFlowName.megaPTM} />},
