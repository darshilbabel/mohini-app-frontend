...
export default function ResourceCard({ resource }) {
  ...
  return (
    ...
    <div className="flex flex-col gap-3.5 p-3.5">
        ...
        {/* Suggestion Chip */}
        <div
          className="absolute left-[10px] top-[10px] bg-[#2563EB] rounded-[8px] py-1 px-[14px]
                     shadow-[0_1px_2px_rgba(0,0,0,0.3),0_1px_3px_1px_rgba(0,0,0,0.15)] flex justify-center items-center w-[47px] h-[22px] z-10"
        >
          <span className="text-white font-manrope font-medium text-[10px] leading-[14px] tracking-[0.1px] flex items-center justify-center">
            PDF
          </span>
        </div>
        ...
        {/* Title over image */}
        <h3
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-manrope font-bold text-[16px] leading-[22px]
                     w-[300px] h-[22px] text-black flex items-center justify-center z-30 text-center"
        >
          {resource?.title}
        </h3>
      </div>
