...
export default function Header() {
  ...
  return (
    <header className="flex flex-col items-end  max-w-[1670px] w-full bg-white rounded-[16px] shadow-[0px_0px_4px_rgba(0,0,0,0.2)]">
        ...
        <>
          ...
          >
            <div className="header-container">
              ...
              <div
                className="w-nav-overlay active"
                data-wf-ignore=""
                id="w-nav-overlay-0"
                style={
                  menuOpen
                    ? { height: "1016.27px", display: "block" }
                ...
                >
                  <div className="grid">
                    ...
                    >
                      ...
                      {dropdownOpen && (
                        <nav className="dropdown-list-2 grid">
                          <a
