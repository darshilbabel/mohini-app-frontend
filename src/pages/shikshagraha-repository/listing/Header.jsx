...
export default function Header({ isHeroSection = true, isBackButton = false, onSidebarToggle, isSidebarOpen = false }) {
  ...
  return (
    <>
      <header className={`flex flex-col p-[25px] md:pb-8 w-full bg-white rounded-[16px] ${!isMobile ? "shadow-[0px_0px_4px_rgba(0,0,0,0.2)]" : ""} ${isMobile && isBackButton ? "items-start" : "items-end"}`}>
