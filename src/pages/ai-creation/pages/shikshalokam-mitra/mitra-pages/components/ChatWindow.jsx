...
function ChatWindow({ isTalking, handleOnSpeaking, handleOnStopSpeaking, isStreamingComplete, setNotMute, userDetail, chatHistory, hasStartedListening = false, hasOverRideId, isDefineChallengeSection, scrollRef, page }) {
