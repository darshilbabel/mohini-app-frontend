...
export default function Header({
  ...
  return (
    <>
            ...
            <>
              ...
              >
                <div className="header-container">
                  ...
                  >
                    <img
                      src="https://shikshagraha.org/wp-content/themes/twentytwentythree-child/images/Group-22x.png"
                      loading="lazy"
                      alt=""
                      className="image-12"
                    />
                  ...
                  >
                    <div
                      style={
                        menuOpen
                          ? { backgroundColor: "#C8C8C8", color: "white" }
                          : {}
                      }
                      className="w-icon-nav-menu flex items-center justify-center w-12 h-12"
                    />
                  </div>
                </div>
              </div>
              <div className="section_full bhj break-words">
          ...
          >
            ...
            {isMobile && onSidebarToggle && (
              <button
                ...
                className="bg-transparent w-fit px-1"
      ...
      {menuOpen && !isMobile && (
        <div
          className="w-screen h-[100dvh]  absolute z-[999] top-0"
          onClick={() => setMenuOpen(false)}
        >
          <div
            className="w-nav-overlay active w-full h-[calc(100vh-9rem)] top-[9rem]"
            data-wf-ignore=""
            id="w-nav-overlay-0"
            style={
              menuOpen
          ...
          >
            <nav
              role="navigation"
              className={
                " " + (menuOpen ? "nav-menu w-nav-menu" : "nav-menu w-nav-menu")
              }
            ...
            >
              <div className="grid">
                ...
                >
                  ...
                  {dropdownOpen && (
                    <nav
                      className="dropdown-list-2 grid"
                      onClick={(e) => e.stopPropagation()}
                    >
                      <a
