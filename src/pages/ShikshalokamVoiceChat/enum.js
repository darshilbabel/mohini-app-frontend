...
export const languageList = [
  ...
  { label: "தமிழ்", value: "ta", excludeFor: [sessionFlowName.megaPTM, SESSION_USECASE_TYPE.YLC, SESSION_USECASE_TYPE.ParentPerceptionSurvey, sessionFlowName.GuestDiscussion,sessionFlowName.LoginDiscussion, sessionFlowName.GuestMiStory, sessionFlowName.LoginMiStory ] },
]
