...
import { clearFromStorage, getFromStorage, handleS3Upload, setInStorage } from "../../services/storage_service"
...
const PTMVoiceBasedChat = () => {
  ...
  const [acceptedTnc, setAcceptedTnC] = useState(getFromStorage("has_accepted_tnc", true))
  ...
  return (
    <>
      <SpeedNotification />
      {getFromStorage("local_route") && !isLoading && !acceptedTnc && <PrivacyPolicyPopup tncText={t("tncText")} onAccept={handleAcceptTnC} useStaticText={false} />}
      <></>
            ...
            onSubmit={async event => {
              ...
              if (!hasStartedListening && !isFetchingData) {
                ...
                const data = {
                  ...
                  question: question,
                  translated_question: last_question?.translated_question || null,
                  answer: textMessage,
