...
import {PDFDownloadLink, Page, Text, View, Document, StyleSheet,Image , Font, render} from "@react-pdf/renderer";
...
const Quixote = () => (
    <Document>
      <Page style={styles.body}>
        ...
        <Image
          style={styles.image}
          src="https://mohini-static.shikshalokam.org/chatbot/storymedia/27/ai-aunty.jpeg"
        />
